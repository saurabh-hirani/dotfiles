...
" ========== python ==========
let g:python3_host_prog='/home/saurabh/.pyenv/shims/python3'
...
" Don't know how black is picking up pyproject.toml
" 1. Updated coc.nvim
" Added coc.nvim
"  "python.formatting.blackArgs": [
"    "--config",
"    "/home/saurabh/pyproject.toml"
"  ],
" 2. Created ~/.config/black (as per https://github.com/psf/black/pull/1899)
...
command! -bang -nargs=? -complete=dir HomeFiles call fzf#vim#files('/home/saurabh', fzf#vim#with_preview({'options': ['--layout=reverse', '--info=inline']}), <bang>0)
command! -bang -nargs=? -complete=dir RepoFiles call fzf#vim#files('/home/saurabh/github', fzf#vim#with_preview({'options': ['--layout=reverse', '--info=inline']}), <bang>0)
